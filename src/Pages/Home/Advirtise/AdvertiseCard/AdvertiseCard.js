      ...
      <div className="card max-w-sm rounded overflow-hidden   bg-red-50 shadow-xl">
        <figure>
          <img
            src={product?.image}
            alt="product"
            className="w-full object-fill h-72   bg-white  rounded-md "
          />
        </figure>
        ...
        <div className="px-2">
          <div className="flex justify-between">
            ...
            <h2
              ...
              className="text-error cursor-pointer flex gap-2 items-center"
            >
              {" "}
              <ExclamationTriangleIcon className="h-4 w-4"></ExclamationTriangleIcon>
              <span className="text-sm mr-3">Report</span>
            </h2>
          </div>
          ...
          <div>
            <p className="flex gap-2 items-center">
              ...
              <span>Original Price : {product?.original_price} $ </span>
            </p>
            <p className="flex gap-2 items-center">
              <CurrencyDollarIcon className="h-5"></CurrencyDollarIcon>{" "}
              <span>New Price : {product?.resale_price} $</span>
            </p>
            <h2 className="flex gap-2 items-center">
              {" "}
              <MapPinIcon className="h-5"></MapPinIcon> Location :{" "}
              {product?.location}
            </h2>
            <p className="flex gap-2 items-center">
              <BuildingStorefrontIcon className="h-5"></BuildingStorefrontIcon>{" "}
              <span>Used Year : {product.year_used}</span>
            </p>
            <h2 className="flex gap-2 items-center">
              <CalendarIcon className="h-5"></CalendarIcon>{" "}
              <span>Post Date : {product.published_date}</span>
            </h2>
