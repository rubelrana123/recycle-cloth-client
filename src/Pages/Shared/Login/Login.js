  ...
  return (
    <div className={`p-32 `}>
      ...
      <input {...register("firstName")}  type="text"  className="input w-full " placeholder="First name" /> */}
          ...
          <div className="form-control">
            ...
            <input
              {...register("password", {
                ...
                minLength: {
                  value: 6,
                  message: "please Provide 6 character or longer",
                },
              })}
              type="password"
              placeholder="********"
          ...
          <input
            type="submit"
            className="my-3 cursor-pointer py-3 rounded-md border-0 text-white w-full bg-primary text-xl font-semibold"
          />
          <div>
            <p className="text-xs text-center sm:px-6 dark:text-gray-400">
              New to Recycle Cloth??
